...
1. Реализация моделей данных с помощью ORM
...
1) Выделение сущностей. Определяются ключевые объекты, которые должны попадать в систему.
1) Определение атрибутов. Выявляются свойства сущностей.
1) Определение связей. Устанавливаются отношения между объектами.
1) Уточнение ограничений. Определяются: обязательные атрибуты, уникальные значения, правила владения данными, бизнес-ограничения.
1) Валидация модели. Проверка модели: на корректность, полноту, отсутствие противоречий, соответствие требованиям. Обычно проводится обсуждение между аналитиками, архитекторами и заказчиком.
...
1. Оптимизация логической схемы
...
1) Определение способов хранения данных
...
1) Размещение объектов по дискам и разделам
...
1) Настройка транзакционности и журналирования
...
1) Оптимизация для типов нагрузки
...
1. Завьялов А. Н., Кудрявцев В. Б. Системы баз данных: учебник для вузов. - М.: КноРус, 2021. - 432 с.
1. Санников С. К. Базы данных. Проектирование: учебное пособие для вузов. - М.: ФОРУМ, 2019. - 304 с.
1. Кабанов В. В. Проектирование баз данных: учебное пособие. - М.: ИНФРА-М, 2017. - 224 с.
1. Кузьмин Г. М., Бабич С. П. Базы данных: учебник. - М.: Академия, 2020. - 384 с.
1. Меликсетян З. А. Базы данных и информационные системы: учебник для вузов. - СПб.: Питер, 2019. - 592 с.
1. Соловьёв В. А., Липунцов А. В. Проектирование информационных систем и баз данных: учебное пособие. - М.: Лань, 2020. - 320 с.
1. Головастиков А. И. Реляционные базы данных: теория и разработка: учебное пособие. - Екатеринбург: УрФУ, 2018. - 198 с.
1. Стефанюк Е. Н. Базы данных: проектирование, реализация, управление. Учебное пособие. - СПб.: БХВ-Петербург, 2016. - 432 с.
1. Шапошников С. А. Модели данных и проектиование баз данных: учебное пособие. - М.: МИЭТ, 2015. - 180 с.
...
![](Aspose.Words.9890b83f-5d53-403d-8461-244b1aab54d6.003.png)
